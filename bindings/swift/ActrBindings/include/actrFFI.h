...
uint64_t uniffi_actr_fn_method_networkeventhandlewrapper_cleanup_connections(uint64_t ptr
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_ACTR_FN_METHOD_NETWORKEVENTHANDLEWRAPPER_HANDLE_NETWORK_AVAILABLE
#define UNIFFI_FFIDEF_UNIFFI_ACTR_FN_METHOD_NETWORKEVENTHANDLEWRAPPER_HANDLE_NETWORK_AVAILABLE
uint64_t uniffi_actr_fn_method_networkeventhandlewrapper_handle_network_available(uint64_t ptr
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_ACTR_FN_METHOD_NETWORKEVENTHANDLEWRAPPER_HANDLE_NETWORK_LOST
#define UNIFFI_FFIDEF_UNIFFI_ACTR_FN_METHOD_NETWORKEVENTHANDLEWRAPPER_HANDLE_NETWORK_LOST
uint64_t uniffi_actr_fn_method_networkeventhandlewrapper_handle_network_lost(uint64_t ptr
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_ACTR_FN_METHOD_NETWORKEVENTHANDLEWRAPPER_HANDLE_NETWORK_TYPE_CHANGED
#define UNIFFI_FFIDEF_UNIFFI_ACTR_FN_METHOD_NETWORKEVENTHANDLEWRAPPER_HANDLE_NETWORK_TYPE_CHANGED
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_ACTR_CHECKSUM_METHOD_NETWORKEVENTHANDLEWRAPPER_HANDLE_NETWORK_AVAILABLE
#define UNIFFI_FFIDEF_UNIFFI_ACTR_CHECKSUM_METHOD_NETWORKEVENTHANDLEWRAPPER_HANDLE_NETWORK_AVAILABLE
uint16_t uniffi_actr_checksum_method_networkeventhandlewrapper_handle_network_available(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_ACTR_CHECKSUM_METHOD_NETWORKEVENTHANDLEWRAPPER_HANDLE_NETWORK_LOST
#define UNIFFI_FFIDEF_UNIFFI_ACTR_CHECKSUM_METHOD_NETWORKEVENTHANDLEWRAPPER_HANDLE_NETWORK_LOST
uint16_t uniffi_actr_checksum_method_networkeventhandlewrapper_handle_network_lost(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_ACTR_CHECKSUM_METHOD_NETWORKEVENTHANDLEWRAPPER_HANDLE_NETWORK_TYPE_CHANGED
#define UNIFFI_FFIDEF_UNIFFI_ACTR_CHECKSUM_METHOD_NETWORKEVENTHANDLEWRAPPER_HANDLE_NETWORK_TYPE_CHANGED
uint16_t uniffi_actr_checksum_method_networkeventhandlewrapper_handle_network_type_changed(void
